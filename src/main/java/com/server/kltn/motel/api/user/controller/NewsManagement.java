...
public class NewsManagement {
	...
	public ResponseEntity<Page<NewsCard>> getPosts(
		...
		Page<NewsCard> posts= newsManagementService.getAllNewsOfUser(pageNo, pageSize, field, mode, authentication.getName());
	...
	public ResponseEntity<Page<NewsCard>> getWattingApproved(
			...
			@RequestParam(value = "mode", defaultValue = PageAndSortConstant.MODE, required = false) int mode,
			Authentication authentication){
		Page<NewsCard> posts= newsManagementService.getNewsWaitingAproved(pageNo, pageSize, field, mode, authentication.getName());
		return new ResponseEntity<Page<NewsCard>>(posts, HttpStatus.OK);
	}
	...
	public ResponseEntity<Page<NewsCard>> getRejectOfUser(
			...
			@RequestParam(value = "mode", defaultValue = PageAndSortConstant.MODE, required = false) int mode,
			Authentication authentication){
		Page<NewsCard> posts= newsManagementService.getNewsRejectOfUser(pageNo, pageSize, field, mode, authentication.getName());
		return new ResponseEntity<Page<NewsCard>>(posts, HttpStatus.OK);
	}
	...
	public ResponseEntity<Page<NewsCard>> getDontPaymentOfUser(
			...
			@RequestParam(value = "mode", defaultValue = PageAndSortConstant.MODE, required = false) int mode,
			Authentication authentication){
		Page<NewsCard> posts= newsManagementService.getDontPaymentOfUser(pageNo, pageSize, field, mode, authentication.getName());
		return new ResponseEntity<Page<NewsCard>>(posts, HttpStatus.OK);
	}
	...
	public ResponseEntity<Page<NewsCard>> getWaittingShowOfUser(
			...
			@RequestParam(value = "mode", defaultValue = PageAndSortConstant.MODE, required = false) int mode,
			Authentication authentication){
		Page<NewsCard> posts= newsManagementService.getWaittingShowOfUser(pageNo, pageSize, field, mode, authentication.getName());
		return new ResponseEntity<Page<NewsCard>>(posts, HttpStatus.OK);
	}
	...
	public ResponseEntity<Page<NewsCard>> getNewsShowingOfUser(
			...
			@RequestParam(value = "mode", defaultValue = PageAndSortConstant.MODE, required = false) int mode,
			Authentication authentication){
		Page<NewsCard> posts= newsManagementService.getNewsShowingOfUser(pageNo, pageSize, field, mode, authentication.getName());
		return new ResponseEntity<Page<NewsCard>>(posts, HttpStatus.OK);
	}
	...
	public ResponseEntity<Page<NewsCard>> getNewsHiddenOfUser(
			...
			@RequestParam(value = "mode", defaultValue = PageAndSortConstant.MODE, required = false) int mode,
			Authentication authentication){
		Page<NewsCard> posts= newsManagementService.getNewsHiddenOfUser(pageNo, pageSize, field, mode, authentication.getName());
		return new ResponseEntity<Page<NewsCard>>(posts, HttpStatus.OK);
	}
